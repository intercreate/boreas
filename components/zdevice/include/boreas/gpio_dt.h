...
struct gpio_api {
    ...
    esp_err_t (*pin_interrupt_configure)(const struct device *port, gpio_num_t pin, uint32_t flags);
...
static inline esp_err_t gpio_add_callback(const struct device *port,
                                           struct gpio_callback *cb)
{
...
static inline esp_err_t gpio_remove_callback(const struct device *port,
                                              struct gpio_callback *cb)
{
...
static inline esp_err_t gpio_port_set_bits_raw(const struct device *port,
                                                gpio_port_pins_t pins)
{
...
static inline esp_err_t gpio_port_clear_bits_raw(const struct device *port,
                                                   gpio_port_pins_t pins)
{
...
static inline esp_err_t gpio_port_get_raw(const struct device *port,
                                           gpio_port_pins_t *values)
{
...
static inline esp_err_t gpio_port_set_masked_raw(const struct device *port,
...
static inline esp_err_t gpio_port_toggle_bits(const struct device *port,
                                               gpio_port_pins_t pins)
{
