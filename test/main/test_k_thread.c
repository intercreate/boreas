...
static void test_thread_abort(void)
{
	...
	k_thread_create(&thread, stack, K_THREAD_STACK_SIZEOF(stack), long_running_entry, NULL,
...
static void test_thread_join(void)
{
	...
	k_thread_create(&thread, stack, K_THREAD_STACK_SIZEOF(stack), short_entry, NULL, NULL, NULL,
			5, 0, K_NO_WAIT);
...
static void test_thread_three_params(void)
{
	...
	k_thread_create(&thread, stack, K_THREAD_STACK_SIZEOF(stack), three_arg_entry,
			(void *)(intptr_t)10, (void *)(intptr_t)20, (void *)(intptr_t)30, 5, 0,
			K_NO_WAIT);
...
static void test_thread_deferred_forever(void)
{
	...
	k_thread_create(&deferred_thread, deferred_stack, K_THREAD_STACK_SIZEOF(deferred_stack),
			deferred_entry, (void *)&deferred_ran, NULL, NULL, 5, 0, K_FOREVER);
...
static void test_thread_deferred_delay(void)
{
	...
	k_thread_create(&deferred_thread, deferred_stack, K_THREAD_STACK_SIZEOF(deferred_stack),
			deferred_entry, (void *)&deferred_ran, NULL, NULL, 5, 0, K_MSEC(200));
